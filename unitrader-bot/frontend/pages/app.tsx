...
export default function AppPage() {
  ...
  const nativeTabs = new Set(["dashboard", "trade", "positions", "chat", "performance", "settings", "notifications"]);
  const mobilePrimaryTabs = new Set(["dashboard", "trade", "positions", "chat", "performance", "settings", "notifications"]);
